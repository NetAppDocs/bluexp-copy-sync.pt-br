...
| https://console.BlueXP .NetApp.com/ https://NetApp-cloud-account.auth0.com | Para entrar em Contato com a classificação do BlueXP  quando você usa a classificação para selecionar os arquivos de origem para uma nova relação de sincronização. 
